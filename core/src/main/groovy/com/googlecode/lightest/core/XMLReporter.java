 ...
 */
public class XMLReporter implements IReporter, ITestRegistryAcceptor {

  private XMLReporterConfig config = new XMLReporterConfig();
  private XMLStringBuffer rootBuffer;
  // HBC - begin Lightest customizations
  private LightestSuiteResultWriter suiteResultWriter;
  
  public XMLReporter() {
      this(new LightestSuiteResultWriter());
  }
  ...
  public TestRegistry getRegistry() {
    return suiteResultWriter.getRegistry();
  }
  
  public void setRegistry(TestRegistry registry) {
      suiteResultWriter.setRegistry(registry);
  }
  ...
  private void writeSuiteToBuffer(XMLStringBuffer xmlBuffer, ISuite suite) {
    ...
    // HBC - begin Lightest customizations
    suiteResultWriter.setConfig(config);
    // HBC - end Lightest customizations
